...
namespace Fotiv_Automator.Areas.GamePortal
{
    public class GamePortalAreaRegistration : AreaRegistration 
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context) 
        {
            ...
            context.MapRoute("ViewRnDResearch", "game/civilizations/ResearchAndDevelopment/Research/{rndResearchID}",        new { controller = "RnDResearch", action = "View" }, namespaces);
            ...
            context.MapRoute("ViewRnDShipConstruction", "game/civilizations/ResearchAndDevelopment/ShipConstruction/{rndShipConstructionID}",       new { controller = "RnDShipConstruction", action = "View" }, namespaces);
            ...
            context.MapRoute("ViewRnDColonialDevelopment", "game/civilizations/ResearchAndDevelopment/ColonialDevelopment/{rndColonialDevelopmentID}",          new { controller = "RnDColonialDevelopment", action = "View" }, namespaces);
